...
L<IPDevice::RouterBase::BGPVRF|IPDevice::RouterBase::BGPVRF>,
...
Returns the
L<IPDevice::RouterBase::BGPGroup|IPDevice::RouterBase::BGPGroup> with the given
name. If the group does not exist yet, a newly created
L<IPDevice::RouterBase::BGPGroup|IPDevice::RouterBase::BGPGroup> will be
returned.
...
Returns the L<IPDevice::RouterBase::BGPVRF|IPDevice::RouterBase::BGPVRF> with
the given name, or, if none found, a new
L<IPDevice::RouterBase::BGPVRF|IPDevice::RouterBase::BGPVRF>.
